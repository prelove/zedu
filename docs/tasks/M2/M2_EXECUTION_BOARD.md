...
| M2-GLM-02B/02C | GLM | 人员资料；课程/报名/安排 API | IN_PROGRESS | M2-GLM-02A ACCEPTED | `docs/tasks/M2/M2-GLM-02BC-core-management.md`；`backend/internal/app/{directory,course}/**`、新领域 application/repository、必要路由装配及测试 | Codex + 独立 Reviewer |
